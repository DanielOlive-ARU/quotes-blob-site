...
- **Phase 4** — expanding the registry to all 10 routes, in the order listed in `IMPLEMENTATION-PLAN.md` §7. _In progress — 4 of 10 implemented: `json_to_text`, `list_to_json_array`, `form_to_json`, `json_to_keyvalue`._
