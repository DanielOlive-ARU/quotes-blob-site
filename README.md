...
- **Phase 4** — expanding the registry to all 10 routes, in the order listed in `IMPLEMENTATION-PLAN.md` §7. _In progress — 8 of 10 implemented: `json_to_text`, `list_to_json_array`, `form_to_json`, `json_to_keyvalue`, `csv_to_json`, `json_array_to_csv`, `json_to_html`, `markdown_to_html`._
